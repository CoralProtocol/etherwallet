...
<!-- / Advanced Option Panel -->
    ...
    <section class="row form-group confirm-coral-fraud-prevention col-xs-12" ng-show="showFraudPrevention || getFraudPreventionSelected()">
      <p class="strong">To enable fraud prevention for your transaction, please check the box below:</p>
      <input type="checkbox" id="fraud-prevention-checkbox" name="fraud-prevention-checkbox" ng-model="fraudPreventionSelected" ng-checked="getFraudPreventionSelected()"></input>
      <label for="fraud-prevention-checkbox" class='checkbox-label'>
        I agree to pay the fraud prevention transaction fee of 1.5% of my transaction + $0.30 USD. <br>
